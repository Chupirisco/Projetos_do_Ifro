...
namespace AppExemploCadastro
{
    public partial class Form1 : Form
    {
        ...
        private void btModificarDados_Click(object sender, EventArgs e)
        {
            FormModificarDados form = new FormModificarDados();
            form.ShowDialog();
        }

        private void btExcluirCadastro_Click(object sender, EventArgs e)
        {
            FormExcluirCadastro form = new FormExcluirCadastro();
            form.ShowDialog();
        }
    }
}
